  ...
  return (
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
      <nav className="text-xs text-neutral-400 mb-8 flex items-center gap-2">
        ...
        <span>/</span>
        <span className="text-neutral-700">Femme</span>
      </nav>
      ...
      <div className="flex gap-3 justify-center mb-10">
        <Link href="/montres/femme" className="px-5 py-2 text-xs tracking-widest uppercase font-medium bg-neutral-900 text-white border border-neutral-900">
          Femme
        </Link>
        <Link href="/montres/homme" className="px-5 py-2 text-xs tracking-widest uppercase font-medium border border-neutral-300 text-neutral-600 hover:border-neutral-900 hover:text-neutral-900 transition-colors">
          Homme
        </Link>
      </div>
